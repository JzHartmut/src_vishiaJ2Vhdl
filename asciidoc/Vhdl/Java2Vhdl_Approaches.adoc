...
[source,Java]
----
@Fpga.VHDL_MODULE public class RAM_SpiRamSel implements FpgaModule_ifc {
----

The port definition should be written as:
...
This is for the example with the RAM block VHDL. Its original VHDL port definition is:

.VHDL: port definition in the given VHDL file
[source,VHDL]
----
entity RAM_SpiRamSel is
    port (
        Clock: in  std_logic; 
...
[source,Java]
----
  @Fpga.LINK_VHDL_MODULE("ram") private static final class Ram{
----

Inside the class the constructor should be written in the following kind:

.Java: usage of given VHDL file in Java code for generation, constructor
[source,Java]
----
    @Fpga.LINK_VHDL_MODULE("ram") Ram(int time, RAM_SpiRamSel vhdlMdl, Modules modules, Ref ref, TxSpe thism) {
